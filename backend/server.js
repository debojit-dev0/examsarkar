...
const SCHOLARSHIP_TESTS_PATH = "scholarshipTests";
const SCHOLARSHIP_SLOTS_PATH = "scholarshipSlots";
const SCHOLARSHIP_ENTRIES_PATH = "scholarshipEntries";
const SCHOLARSHIP_LEADERBOARD_PATH = "scholarshipLeaderboard";
const SCHOLARSHIP_PRIZES_PATH = "scholarshipPrizes";
...
app.post("/api/scholarship/create-order", verifyToken, async (req, res) => {
  try {
    ...
    const txResult = await slotsRef.transaction((current) => {
      ...
      if (count >= SCHOLARSHIP_MAX_SLOTS) return;
      return count + 1;
    });
